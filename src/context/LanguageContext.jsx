...
export const translations = {
  en: {
    nav: {
      ...
      setting: 'SETTING',
      settingSub: 'Preferences & Setup',
      reviews: 'REVIEWS',
      reviewsSub: 'Ratings & Community Feedback',
      control: 'Control',
      ...
      adminPanel: 'Control Gateway',
      qrScanner: 'Scan QR Code'
    },
    hero: {
      name: 'Rasedul Karim',
      bio: 'Software & Web Developer | Photo Editor | Digital Creator',
      location: "Natun Pollan Para, Teknaf, Cox's Bazar, Bangladesh",
    ...
    bento: {
      seeProjectTitle: 'See Project',
      seeProjectSub: 'Fresh Works & Showcase',
      designProjectTitle: 'Design Project',
      designProjectSub: 'Watch & Explore',
      upcomingProjectTitle: 'Upcoming Project',
      upcomingProjectSub: 'In Development & Pipeline',
      favoriteTitle: 'Favorite',
      favoriteSub: 'My Favorite Tools',
      dealsTitle: 'Deals & Discounts',
      dealsSub: 'Exclusive Offers',
      newsletterTitle: 'Join My Newsletter',
      newsletterSub: 'Stay updated',
      featuredTitle: 'Explore Portfolio Card & Bio',
      featuredSub: 'Download Full-HD Branded Digital Card & Bio',
      downloadBtn: 'Download Now / Explore'
    },
    stackedLinks: {
  ...
  bn: {
    nav: {
      ...
      reviews: 'রেটিং ও রিভিউ',
      reviewsSub: 'গ্রাহক মূল্যায়ন ও প্রতিক্রিয়া',
      control: 'কন্ট্রোল',
      selectLanguage: 'Select Language',
      ...
      themeDark: 'ডার্ক মোড',
      themeLight: 'লাইট মোড',
      adminPanel: 'কন্ট্রোল প্যানেল',
      qrScanner: 'QR কোড স্ক্যানার'
    },
    hero: {
      name: 'রাশেদুল করিম',
      bio: 'সফটওয়্যার ও ওয়েব ডেভেলপার | ফটো এডিটর | ডিজিটাল ক্রিয়েটর',
      location: 'নতুন পল্লান পাড়া, টেকনাফ, কক্সবাজার, বাংলাদেশ',
    ...
    bento: {
      seeProjectTitle: 'See Project',
      seeProjectSub: 'নতুন কাজ ও পোর্টফোলিও',
      designProjectTitle: 'Design Project',
      designProjectSub: 'ক্রিয়েটিভ ডিজাইন ও আর্ট',
      upcomingProjectTitle: 'Upcoming Project',
      upcomingProjectSub: 'ভবিষ্যৎ সিস্টেম ও লক্ষ্য',
      favoriteTitle: 'Favorite',
      favoriteSub: 'প্রিয় সফটওয়্যার ও টুলস',
      dealsTitle: 'Deals & Discounts',
      dealsSub: 'বিশেষ অফার ও সুযোগ',
      newsletterTitle: 'Join My Newsletter',
      newsletterSub: 'সর্বশেষ আপডেটের সাথে থাকুন',
      featuredTitle: 'ডিজিটাল পোর্টফোলিও ও প্রোফাইল কার্ড',
      featuredSub: 'ফুল-এইচডি ডিজিটাল পরিচিতি কার্ড ও ডকুমেন্ট',
      downloadBtn: 'ডাউনলোড / বিস্তারিত দেখুন'
    },
    stackedLinks: {
